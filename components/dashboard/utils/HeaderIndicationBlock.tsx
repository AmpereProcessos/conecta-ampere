	...
	return (
		<div className="flex w-full items-center justify-center gap-1.5">
			<div className="flex items-center gap-1 rounded-lg border border-[#15599a] bg-blue-50 px-2 py-0.5">
				...
				<Link className="text-center font-bold text-[#15599a] text-[0.5rem] italic lg:text-xs" href={`/invites/promoter/${sessionUserId}`}>
			...
			>
				...
				<h1 className="text-center font-bold text-[0.5rem] text-primary/80 italic lg:text-xs">COPIAR LINK</h1>
			</button>
		</div>
	);
}
