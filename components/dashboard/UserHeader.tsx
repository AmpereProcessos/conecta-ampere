'use server';
import { IdCard, LogOut, Mail, Phone, Shield } from 'lucide-react';
...
function UserHeader({ sessionUser }: UserHeaderProps) {
	return (
		<>
			<div className="flex w-full items-center justify-between gap-1.5 rounded-lg border border-primary/20 bg-background p-3.5 shadow-xs">
			...
			<div className="flex w-full flex-col gap-3 rounded-lg border border-primary/20 bg-background p-3.5 shadow-xs">
