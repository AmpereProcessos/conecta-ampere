...
function NumberInput({ identifier, labelText, placeholderText, value, editable = true, handleChange, wrapperClassName, labelClassName, inputClassName }: NumberInputProps) {
